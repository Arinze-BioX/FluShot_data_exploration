...
Now. let's try imputing by random for health insurance.
```{r}
set.seed(123)
table(trainingDF[trainingDF$seasonal_vaccine==FALSE& trainingDF$h1n1_vaccine==FALSE,'health_insurance'])
table(trainingDF[trainingDF$seasonal_vaccine==FALSE& trainingDF$h1n1_vaccine==TRUE,'health_insurance'])
table(trainingDF[trainingDF$seasonal_vaccine==TRUE& trainingDF$h1n1_vaccine==FALSE,'health_insurance'])
table(trainingDF[trainingDF$seasonal_vaccine==TRUE& trainingDF$h1n1_vaccine==TRUE,'health_insurance'])

library(caTools)
ind1<-which(trainingDF$seasonal_vaccine==FALSE& trainingDF$h1n1_vaccine==FALSE&is.na(trainingDF$health_insurance))
ind2<-which(trainingDF$seasonal_vaccine==FALSE& trainingDF$h1n1_vaccine==TRUE&is.na(trainingDF$health_insurance))
ind3<-which(trainingDF$seasonal_vaccine==TRUE& trainingDF$h1n1_vaccine==FALSE&is.na(trainingDF$health_insurance))
ind4<-which(trainingDF$seasonal_vaccine==TRUE& trainingDF$h1n1_vaccine==TRUE&is.na(trainingDF$health_insurance))

samp1<-sample.split(ind1,SplitRatio = 0.19)
samp2<-sample.split(ind2,SplitRatio = 0.13)
samp3<-sample.split(ind3,SplitRatio = 0.064)
samp4<-sample.split(ind4,SplitRatio = 0.046)

false.indices=c(ind1[samp1==TRUE], ind2[samp2==TRUE], ind3[samp3==TRUE], ind4[samp4==TRUE])
training.random<-trainingDF
training.random[false.indices,'health_insurance']<-FALSE
training.random[!false.indices,'health_insurance']<-TRUE
```

Random imputation for doctor's recc seasonal
```{r}
set.seed(123)
table(trainingDF[trainingDF$seasonal_vaccine==FALSE& trainingDF$h1n1_vaccine==FALSE,'doctor_recc_seasonal'])
table(trainingDF[trainingDF$seasonal_vaccine==FALSE& trainingDF$h1n1_vaccine==TRUE,'doctor_recc_seasonal'])
table(trainingDF[trainingDF$seasonal_vaccine==TRUE& trainingDF$h1n1_vaccine==FALSE,'doctor_recc_seasonal'])
table(trainingDF[trainingDF$seasonal_vaccine==TRUE& trainingDF$h1n1_vaccine==TRUE,'doctor_recc_seasonal'])

library(caTools)
ind1<-which(trainingDF$seasonal_vaccine==FALSE& trainingDF$h1n1_vaccine==FALSE&is.na(trainingDF$doctor_recc_seasonal))
ind2<-which(trainingDF$seasonal_vaccine==FALSE& trainingDF$h1n1_vaccine==TRUE&is.na(trainingDF$doctor_recc_seasonal))
ind3<-which(trainingDF$seasonal_vaccine==TRUE& trainingDF$h1n1_vaccine==FALSE&is.na(trainingDF$doctor_recc_seasonal))
ind4<-which(trainingDF$seasonal_vaccine==TRUE& trainingDF$h1n1_vaccine==TRUE&is.na(trainingDF$doctor_recc_seasonal))

samp1<-sample.split(ind1,SplitRatio = 0.84)
samp2<-sample.split(ind2,SplitRatio = 0.766)
samp3<-sample.split(ind3,SplitRatio = 0.526)
samp4<-sample.split(ind4,SplitRatio = 0.429)

false.indices=c(ind1[samp1==TRUE], ind2[samp2==TRUE], ind3[samp3==TRUE], ind4[samp4==TRUE])
training.random<-trainingDF
training.random[false.indices,'doctor_recc_seasonal']<-FALSE
training.random[!false.indices,'doctor_recc_seasonal']<-TRUE
```

```{r}
set.seed(123)
table(trainingDF[trainingDF$seasonal_vaccine==FALSE& trainingDF$h1n1_vaccine==FALSE,'doctor_recc_h1n1'])
table(trainingDF[trainingDF$seasonal_vaccine==FALSE& trainingDF$h1n1_vaccine==TRUE,'doctor_recc_h1n1'])
table(trainingDF[trainingDF$seasonal_vaccine==TRUE& trainingDF$h1n1_vaccine==FALSE,'doctor_recc_h1n1'])
table(trainingDF[trainingDF$seasonal_vaccine==TRUE& trainingDF$h1n1_vaccine==TRUE,'doctor_recc_h1n1'])

library(caTools)
ind1<-which(trainingDF$seasonal_vaccine==FALSE& trainingDF$h1n1_vaccine==FALSE&is.na(trainingDF$doctor_recc_h1n1))
ind2<-which(trainingDF$seasonal_vaccine==FALSE& trainingDF$h1n1_vaccine==TRUE&is.na(trainingDF$doctor_recc_h1n1))
ind3<-which(trainingDF$seasonal_vaccine==TRUE& trainingDF$h1n1_vaccine==FALSE&is.na(trainingDF$doctor_recc_h1n1))
ind4<-which(trainingDF$seasonal_vaccine==TRUE& trainingDF$h1n1_vaccine==TRUE&is.na(trainingDF$doctor_recc_h1n1))

samp1<-sample.split(ind1,SplitRatio = 0.883)
samp2<-sample.split(ind2,SplitRatio = 0.547)
samp3<-sample.split(ind3,SplitRatio = 0.842)
samp4<-sample.split(ind4,SplitRatio = 0.46)

false.indices=c(ind1[samp1==TRUE], ind2[samp2==TRUE], ind3[samp3==TRUE], ind4[samp4==TRUE])
training.random<-trainingDF
training.random[false.indices,'doctor_recc_h1n1']<-FALSE
training.random[!false.indices,'doctor_recc_h1n1']<-TRUE
```
...
X.rand_train <- training.random[train_ind, ]
X.rand_test <- training.random[-train_ind, ]
y.rand_train = labels[train_ind,]
y.rand_test= labels[-train_ind,]
```
