...
\quad \\
\quad \\
\textbf{Table 1: Summary of statistics of all variables (including the output)}
\end{center}
\end{@twocolumnfalse}
]
\onecolumn{
\begin{center}
\begin{tabular}{cc}
\multicolumn{2}{c}{\includegraphics[scale=0.6]{missingnessMap}}\\
\multicolumn{2}{c}{Fig 1. Visual representation of missing values}\\
\includegraphics[width=0.5\columnwidth]{children} & \includegraphics[width=0.5\columnwidth]{opinions}\\
Fig 2. & Fig 3.\\ 
\end{tabular}
\end{center}
