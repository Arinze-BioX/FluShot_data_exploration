...
cc_complete_hx <- model.matrix(h1n1_vaccine~., completeCases)[,-1]
cc_complete_hy <- completeCases[,36]
cc_complete_sx <- model.matrix(seasonal_vaccine~., completeCases)[,-c(1,102)]
...
rand_complete_hx <- model.matrix(h1n1_vaccine~., randImp)[,-1]
rand_complete_hy <- randImp[,36]
rand_complete_sx <- model.matrix(seasonal_vaccine~., randImp)[,-c(1,102)]
rand_complete_sy <- randImp[,37]
```
...
cc_train_hx <- model.matrix(h1n1_vaccine~.,cc_train_df)[,-1]
cc_train_hy = cc_train_df[,36]
cc_train_sx <- model.matrix(seasonal_vaccine~.,cc_train_df)[,-c(1,102)]
cc_train_sy = cc_train_df[,37]

cc_test_hx <- model.matrix(h1n1_vaccine~.,cc_test_df)[,-1]
cc_test_hy = cc_test_df[,36]
cc_test_sx <- model.matrix(seasonal_vaccine~.,cc_test_df)[,-c(1,102)]
cc_test_sy = cc_test_df[,37]

rand_train_hx <- model.matrix(h1n1_vaccine~.,rand_train_df)[,-1]
rand_train_hy = rand_train_df[,36]
rand_train_sx <- model.matrix(seasonal_vaccine~.,rand_train_df)[,-c(1,102)]
rand_train_sy = rand_train_df[,37]

rand_test_hx <- model.matrix(h1n1_vaccine~.,rand_test_df)[,-1]
rand_test_hy = rand_test_df[,36]
rand_test_sx <- model.matrix(seasonal_vaccine~.,rand_test_df)[,-c(1,102)]
